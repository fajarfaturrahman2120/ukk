...
<body class="bg-light">
    <div class="vh-100 d-flex justify-content-center align-items-center">
        <form action="" method="post" class="col-md-9 bg-white border rounded-4 p-4 shadow-lg">
            ...
            <h3 class="text-center mb-1">Data Pengaduan</h3>
            ...
            <table class="table table-bordered table-striped">
                ...
                include 'koneksi.php';
                $no = 1;
                $sql = "SELECT * FROM input_aspirasi,kategori,aspirasi WHERE input_aspirasi.id_kategori=kategori.id_kategori AND
                ...
                <tr>
                    ...
                    <td>
                        <a href="detail.php?id=<?= $pengaduan['id_pelaporan'] ?> " class="btn btn-primary">Detail</a>
                    </td>
